...
set GRPC_PATH=E:\Facultate\AN2\Semestrul2\Cloud-NativeApplications\Download\vcpkg-master\vcpkg-master\installed\x86-windows\tools\grpc
set PROTOC_PATH=E:\Facultate\AN2\Semestrul2\Cloud-NativeApplications\Download\vcpkg-master\vcpkg-master\installed\x86-windows\tools\protobuf
